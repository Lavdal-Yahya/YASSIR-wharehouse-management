-- CreateEnum
CREATE TYPE "Role" AS ENUM ('OWNER', 'WAREHOUSE', 'SHOP');
...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_assignedShopId_fkey" FOREIGN KEY ("assignedShopId") REFERENCES "Shop"("id") ON DELETE SET NULL ON UPDATE CASCADE;
