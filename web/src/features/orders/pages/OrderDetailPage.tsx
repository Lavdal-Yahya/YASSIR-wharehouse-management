  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm md:grid-cols-3 text-sm text-slate-700">
        <div>
          <div className="text-xs text-slate-500">{t('orders.form.orderDate')}</div>
        ...
        {o.cancellationReason ? (
          <div className="md:col-span-3">
            <div className="text-xs text-slate-500">{t('orders.cancelReason')}</div>
            <div className="text-red-700">{o.cancellationReason}</div>
          </div>
        ) : null}
      </div>
      ...
      <div className="rounded-xl border border-slate-200 bg-white shadow-sm">
        ...
        <ul className="divide-y divide-slate-100">
          {o.items.map((it) => (
            <li
              key={it.id}
              className="grid gap-1 p-4 text-sm text-slate-700 md:grid-cols-[1fr_6rem_6rem_6rem_7rem] md:items-center md:gap-3"
            >
